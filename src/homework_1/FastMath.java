 ...
 * @version 1.2
 * 
 *          This class contains methods for rapidly calculating basic mathematical operations.
 */
public class FastMath {
	/**
	 * The "magic" constant which is used in the fast inverse square root algorithm.
	 * 
	 * The given initial value is just a test value for 8 mantissa bits and 4 exponent bits, and has
	 * to be optimized by the students.
	 * 
	 * In literature, several of those constants for floats or doubles can be found. There's no
	 * optimal constant for all cases.
	 */
	...
	/**
	 * This method contains the code for the fast inverse square root algorithm which can e.g. be
	 * found in "Fast Inverse Square Root" from Lomont, Chris (February, 2003).
	 * 
	...
	/**
	 * Calculates the absolute error between the result of the fast inverse square root algorithm and
	 * the "exact" IEEE-conform result.
	 * 
	...
	public static double absInvSqrtErr(Gleitpunktzahl x) {
		...
		double approx = FastMath.invSqrt(x).toDouble();
	...
	/**
	 * Calculates the relative error between the result of the fast inverse square root algorithm and
	 * the "exact" IEEE-conform result.
	 * 
	...
	public static double relInvSqrtErr(Gleitpunktzahl x) {
		double absErr = FastMath.absInvSqrtErr(x);
	...
	/**
	 * Uebersetzt die Gleitpunktzahl in eine Bitfolge (int) aehnlich dem IEEE Standard, d.h. in die
	 * Form [Vorzeichen, Exponent, Mantisse], wobei die führende 1 der Mantisse nicht gespeichert
	 * wird. Dieser Wechsel ist noetig für ein Funktionieren des Fast Inverse Sqrt Algorithmus
	 */
	...
	/**
	 * Liefert aus einer Bitfolge (int) in IEEE Darstellung, d.h. [Vorzeichen, Exponent, Mantisse]
	 * mit Mantisse ohne führende Null, die entsprechende Gleitpunktdarstellung
	 */
