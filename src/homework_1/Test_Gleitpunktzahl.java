...
public class Test_Gleitpunktzahl {
	...
	public static void main(String[] argv) {
		...
		//Schoen in Methoden. Das ist viel �bersichtlicher und einfacher zum testen.
	}
	...
	public static void test_Gleitpunktzahl() {
		...
		try {
			...
			if (x.compareAbsTo(gleitref) != 0
				...
				Test_Gleitpunktzahl.printErg("" + x.toDouble(), ""
					+ gleitref.toDouble());
			} else {
		...
		try {
			...
			if (gleiterg.compareAbsTo(gleitref) != 0
				...
				Test_Gleitpunktzahl.printAdd(x.toString(), y.toString());
				Test_Gleitpunktzahl.printErg(gleiterg.toString(),
					gleitref.toString());
			} else {
				System.out.println("    Richtiges Ergebnis\n");
			}
		...
		try {
			System.out
				.println("Test der Subtraktion mit Gleitpunktzahl");
			...
			if (gleiterg.compareAbsTo(gleitref) != 0
				|| gleiterg.vorzeichen != gleitref.vorzeichen) {
				Test_Gleitpunktzahl.printSub(x.toString(), y.toString());
				Test_Gleitpunktzahl.printErg(gleiterg.toString(),
					gleitref.toString());
			} else {
				System.out.println("    Richtiges Ergebnis\n");
