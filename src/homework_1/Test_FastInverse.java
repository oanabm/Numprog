 ...
 * @version 1.1
 * 
 *          This class just contains a main() method to use the FastMath class and to invoke the
 *          plotter.
 */
public class Test_FastInverse {
	...
	/**
	 * Uses the FastMath class and invokes the plotter. In a logarithmically scaled system, the exakt
	 * solutions of 1/sqrt(x) are shown in green, and the absolute errors of the Fast Inverse Square
	 * Root in red. Can be used to test and debug the own implementation of the fast inverse square
	 * root algorithm and to play while finding an optimal magic number.
	 * 
	...
	public static void main(String[] args) {
		...
		Gleitpunktzahl
			.setSizeMantisse(Test_FastInverse.anzBitsMantisse);
		FastMath.setMagic(Test_FastInverse.MAGIC_NUMBER);
